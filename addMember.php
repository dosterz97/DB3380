<?php
    ...
    $parentTwoLastName = $_POST['parent2lname'];
    ...
    $queryToAdd = "INSERT INTO Member (pawprint, firstName, lastName, semesterJoined, position, mStatus, yearInSchool, roomNumber, seniority) VALUES ('$pawprint', '$firstName', '$lastName', '$semesterJoined', '$position', '$mStatus', '$yearInSchool', '$room', '$seniority');";
